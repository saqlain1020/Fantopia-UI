  ...
  return (
    <div className={classes.root}>
      <div className={classes.switches}>
        ...
        <IOSSwitch onClick={() => setState({...state,putOnSale: !state.putOnSale})} />
      </div>
        ...
        {state.putOnSale && (
          <>
            ...
            <Grid item xs={4}>
              <div
                className={
                  state.saleKind === 1 ? classes.saleBtnsActive : classes.saleBtns
                }
            ...
            <Grid item xs={4}>
              <div
                className={
                  state.saleKind === 2 ? classes.saleBtnsActive : classes.saleBtns
                }
